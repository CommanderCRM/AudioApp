...
async def send_access_token_for_check(request: Request):
    ...
    return check_token(access_token, 'doctor')
...
async def send_refresh_token_for_check(request: Request):
    ...
    return check_token(refresh_token, 'doctor')
...
async def login(request: Request):
    ...
    return check_data_and_login(login_info.username, login_info.password, 'doctor')
